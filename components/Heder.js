...
const Header = () => {
  ...
  return (
    <View className = "flex-row pb-3 items-center mx-4 space-x-5">
        <TouchableOpacity style={{alignItems:"center", backgroundColor:"#1e3135", borderColor:"#1d1d1d", borderWidth:0, height: heightPercentageToDP(5), paddingLeft:10, borderRadius:20, marginTop:10}} className="flex-row flex-1 space-x-2">
